...
if survey_intent and not st.session_state.gpt_response:
    ...
    prompt = f"""
        ...
        결과: (재생성한 구체화된 설문의도)
        (재생성한 구체화된 설문의도)에 설문을 구체적이며 정제한 설문의도를 작성한다.
    """
                        ...
                        for choice in part.choices:
                            ...
                            if finish_reason == 'stop':
                                ...
                                prompt = f"""
                                    ...
                                    설문제작 전문가로서, 설문의도와 '성별'과 관련된 최근 사회적 이슈에 대한 설문조사 질문과 답변을 만들어주세요.
                                    성별 정보를 얻는 간단한 질문은 하지 않고 논쟁적인 질문을 생성한다.
                                    설문의도와 성별과 연관된 설문조사 질문을 생성할 수 없다면 'X'를 출력한다.
                                    성별과 연관없는 설문은 만들 필요 없습니다.
                                ...
                                prompt = f"""
                                    ...
                                    설문제작 전문가로서, 설문의도와 '연령'과 관련된 최근 사회적 이슈에 대한 설문조사 질문과 답변을 만들어주세요.
                                    성별 정보를 얻는 간단한 질문은 하지 않고 논쟁적인 질문을 생성한다.
                                    설문의도와 연령과 연관된 설문조사 질문을 생성할 수 없다면 'X'를 출력한다.
                                    연령과 연관없는 설문은 만들 필요 없습니다.
...
if st.session_state.button_clicked:
    ...
    headers = {
        'accept': 'application/json',
        'Authorization': 'Bearer eyJhbGciOiJIUzUxMiJ9..w4rtX2PxwKS4ppoHVWFISgzpU6nw6v9FtR1gz61SfQUU9_SU3VMWSTPegB95M7jnBjtR_El7YhoflDvF2l_3gA',
